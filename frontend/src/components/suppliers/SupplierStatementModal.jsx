...
const SupplierStatementModal = ({ supplier, onClose }) => {
                    ...
                    <div className="bg-gradient-to-r from-blue-700 to-blue-900 px-6 py-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-xl font-bold text-white leading-tight">Estado de Cuenta</h3>
                                    <p className="text-blue-200 text-sm font-medium">{supplier?.name}</p>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                    ...
                    <div className="bg-gray-50 flex flex-col min-h-[500px] max-h-[80vh]">
                        {loading ? (
                            ...
                            <div className="flex-1 flex items-center justify-center p-6 text-gray-500">
                                No hay datos disponibles para este proveedor.
                            </div>
                        ) : (
                                ...
                                <div className="flex-1 overflow-y-auto px-6 py-6 pb-20">
                                    ...
                                    {statementData.summary[selectedCurrency] ? (
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                                            {renderSummaryCard(
                                                'Total Comprado (Deuda Histórica)',
                                        ...
                                        <div className="bg-orange-50 text-orange-800 p-4 rounded-lg mb-8 text-center font-medium">
                                            No hay operaciones registradas en esta moneda para este proveedor.
                                        </div>
                                    )}
                                                    ...
                                                    {getFilteredLedger().length === 0 ? (
                                                        ...
                                                        getFilteredLedger().map((t) => (
                                                            <tr key={t.id} className="hover:bg-blue-50/50 transition-colors">
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap">
                                                                    <div className="flex flex-col">
                                                                        <span className={`text-sm font-semibold ${t.type === 'charge' ? 'text-orange-600' :
                                                                            ...
                                                                            {t.type === 'charge' ? 'Comprobante CXP' :
                                                                                t.isInternal ? 'Abono Interno (Saldo a Favor)' : 'Depósito / Traspaso'}
                                                                        </span>
                                                                ...
                                                                <td className="px-6 py-4 whitespace-nowrap text-sm text-right font-medium">
                                                                    {t.type !== 'charge' ? (
                                                                        <span className={t.isInternal ? "text-purple-600" : "text-green-600"}>
