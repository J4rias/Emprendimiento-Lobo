...
const STATUS_VARIANT = { draft:'neutral', sent:'info', confirmed:'warning', partial:'info', received:'success', cancelled:'error' };
const STATUS_LABEL   = { draft:'Borrador', sent:'Enviada', confirmed:'Confirmada', partial:'Parcial', received:'Recibida', cancelled:'Cancelada' };
const PAYMENT_VARIANT = { pending:'warning', partial:'info', paid:'success', overdue:'error' };
const PAYMENT_LABEL   = { pending:'Pago Pendiente', partial:'Pago Parcial', paid:'Pagado', overdue:'Vencido' };
...
const PurchaseOrderViewSheet = ({ open, onClose, order }) => {
