 ...
 */
export function PaymentFormModal({ open, onClose, onSuccess, suppliers, isPending }) {
  ...
  // Rate state
  const [rateType, setRateType] = useState('system');
  ...
  const handleRateApply = (rateStr, from, to) => {
    setFormData((prev) => ({
      ...prev,
