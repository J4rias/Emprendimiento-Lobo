 ...
 *   />
 */
export function useTableLimit(defaultValue: number = DEFAULT_LIMIT): [number, (n: number) => void] {
 ...
 */
export function Pagination({ page, totalPages, total, limit = DEFAULT_LIMIT, onPageChange, onLimitChange }: PaginationProps) {
