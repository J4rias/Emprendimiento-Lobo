    ...
    <div className="px-3 pb-3 pt-1.5">
      ...
      <div className="mt-2 pt-1.5 border-t border-gray-50">
        <p className="text-base font-bold text-slate-900 leading-none">
          $ {Number(product.package_price).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
        </p>
        <p className="text-[10px] text-gray-400 mt-0.5">
          $ {Number(product.unit_price).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} c/u
        </p>
      </div>
    </div>
  </div>
