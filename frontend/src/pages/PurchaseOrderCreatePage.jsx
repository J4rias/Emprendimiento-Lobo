                      ...
                      <tr key={index}>
                        ...
                        <td className="px-4 py-3 text-right">
                          <input
                            ...
                            className="w-20 px-2 py-1 text-sm text-right border border-gray-300 rounded focus:ring-2 focus:ring-primary-200 focus:outline-none"
                          />
                        </td>
                        <td className="px-4 py-3 text-right">
                          <input
                        ...
                        <td className="px-4 py-3 text-right">
                          <input
                            ...
                            className="w-16 px-2 py-1 text-sm text-right border border-gray-300 rounded focus:ring-2 focus:ring-primary-200 focus:outline-none"
                          />
                        </td>
      ...
      >
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-9 pr-9 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-200 focus:outline-none text-sm"
            autoFocus
          />
          {productSearch && (
            <button
