...
module.exports = {
  async up(queryInterface, Sequelize) {
    // Check product_presentations table first
    const presentationsTable = await queryInterface.describeTable('product_presentations');

    // Add purchase_currency to product_presentations if it doesn't exist
    if (!presentationsTable.purchase_currency) {
